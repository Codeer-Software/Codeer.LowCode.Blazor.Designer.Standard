...
- Cookie 認証 (プレーンな `app_users` テーブル + 独自ハッシュ。詳細は [認証の仕組み](temporary/_specs/Authentication.md)) で alice / bob / carol / dave / admin の 5 ユーザーが seed されている (パスワード: `test`、admin は `admin`)
