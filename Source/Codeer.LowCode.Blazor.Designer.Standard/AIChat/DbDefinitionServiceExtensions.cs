...
{
    internal static class DbDefinitionServiceExtensions
    {
        internal sealed class DbExtraDefinitions
        {
        ...
        sealed class StringTupleComparer : IEqualityComparer<(string a, string b, string c)>
        {
