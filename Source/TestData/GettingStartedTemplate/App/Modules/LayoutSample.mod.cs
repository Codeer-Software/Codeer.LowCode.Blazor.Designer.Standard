void LayoutTest_OnDetailInitialize()
{
    ...
    Demo_T2_R1Item.Value = "ペン";
    Demo_T2_R1Price.Value = 120;
    Demo_T2_R1Qty.Value = 3;
    Demo_T2_R1Sub.Value = 360;
    Demo_T2_R2Item.Value = "ノート";
    Demo_T2_R2Price.Value = 250;
    Demo_T2_R2Qty.Value = 2;
    Demo_T2_R2Sub.Value = 500;
